...
|---------|----------------------|-------------|
| **Les consommables** | On les boit, on les mange, on les brûle | Soutenir le corps, calmer la fièvre, déclencher un sort, nourrir une fête |
| **Les pièces d'équipement** | On les revêt, on les attache, on les noue | Couvrir, parer, signer une appartenance, conduire une force discrète |
...
|-------|-------------|-------------------|
| Premier | Commun | Ce qu'on trouve au marché, ce qui sert et qu'on ne pleure pas |
| Deuxième | Façonné | Sorti de mains attentives, un cran au-dessus du nécessaire |
| Troisième | Œuvré | L'ouvrage d'un artisan reconnu, signé, attendu |
| Quatrième | Magistral | Ce qu'un Maître produit quand le jour s'aligne |
| Cinquième | Légendaire | Une chose dont on parle dans d'autres villes que la sienne |
| Sixième | Mythique | Une rumeur faite objet, dont l'existence elle-même se discute |

Les objets des plus hauts degrés portent une fragilité particulière : lorsque le Souffle passe, ils perdent un peu de leur éclat le temps que leurs vertus retrouvent leur place dans la nouvelle composition cosmique. Ce n'est pas une déchéance ; c'est l'aveu honnête qu'aucune œuvre ne traverse les saisons du monde sans devoir, elle aussi, se ré-accorder.

---

## Plan de la traversée

Ce hub n'épuise pas son sujet. Il ouvre cinq portes vers d'autres chambres du même bâtiment.

- **[[Catégories d'Items]]** — les grandes familles, telles que les habitants les reconnaissent dans leur quotidien.
- **[[Types d'Items]]** — la nature détaillée de chaque chose, slot par slot, type par type.
- **[[Sources de Ressources]]** — d'où viennent les matières premières, qui les récolte, par quels gestes elles entrent dans le monde des objets.
- **[[Crafts]]** — l'art du faire, les ateliers, les patiences, les transmissions.

Chacune de ces pages raconte le même monde, sous un angle différent. On peut les lire dans l'ordre ou n'en lire qu'une ; le tissu, lui, reste le même.

---

## Liens vivants

Les objets ne tiennent pas seuls. Ils sont pris dans des liens — économiques, sociaux, cosmiques.
...
- [[Architecture]] — la trame profonde du monde, dont les objets sont une des écritures.
...
- Pour les fiches détaillées de chaque archétype d'objet (stats, slots, synergies) : voir le [[_Index|Item Catalog]] dans `05 - Implémentation Unreal/Progression et Inventaire/Item Catalog/`.
- Pour la spécification technique des objets et des recettes : [[Inventory Items]], [[Data Tables Items]].

---

*« Donne à un voyageur une chose qu'il a faite lui-même. Elle pèsera, dans sa main, plus que dix qu'il aura achetées. »*
*— Maréa l'herboriste, Astravia*
