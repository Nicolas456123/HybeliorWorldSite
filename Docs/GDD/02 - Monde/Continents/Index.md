...
# Continents d'Hybelior

> Vue d'ensemble des continents et de leurs nations. Chaque continent a sa fiche detaillee
> (climat, geographie, peuples) et chaque nation sa propre fiche (politique, cultures, economie).
>
> **Note** : ces fiches sont la couche **technique/factuelle** du monde. Pour le **recit narratif**
> (chroniques, histoires de personnages, ambiance), voir `Lore/Pays/` et `Lore/Histoires/`.
...
## Lignees civilisationnelles

Chaque continent est rattache a une (ou plusieurs) **lignee** civilisationnelle. Voir [[Lignées]] pour le detail des lignees canoniques.

---

*Liens : [[02 - Monde/Index|02 - Monde]] | [[Géographie]] | [[Cosmologie]] | [[Lignées]] | [[Frise]]*
