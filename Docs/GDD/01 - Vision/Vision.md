...
Enfin, **la magie est réinventée**. Les effets restent ceux qu'on attend d'une fantasy classique — feu, glace, foudre, soin. Mais leur nomenclature, leur cosmologie, leur présentation, sont autres. Pas de "Fireball niveau 3" ; à Hybelior, c'est une Voie qu'on suit, un Lien qu'on porte, une **Polyphonie** dont on apprend à se faire l'instrument. Cette différence de langage n'est pas cosmétique : elle change ce que le joueur ressent quand il lance un sort. Il ne *cast* plus ; il **résonne**.
