...
Les **Déliés** ont fait l'autre choix. Ils ne s'accordent pas entre eux sur le pourquoi : les uns tiennent que le Pacte Primordial fut **rompu jadis**, et que tout ce qu'on appelle réalité n'en est plus que le débris ; les autres, qu'il est une **prison consentie**, toujours en vigueur, dont les Éternels sont à la fois geôliers et prisonniers. Mais tous concluent pareil. Le Souffle n'est pas une respiration — c'est le bruit qu'on fait, encore et encore, pour rappeler aux mortels qu'ils sont enchaînés. Vivre en accord avec le monde, c'est perpétuer cette captivité. Il faut, disent-ils, **se sevrer**. Apprendre à ne plus respirer avec le cosmos. Devenir un point dur, étranger, qui ne dérive plus avec les voix Éternelles. Au prix d'une déconnexion profonde — car celui qui ne respire plus avec le monde, le monde, à terme, ne le respire plus non plus.
