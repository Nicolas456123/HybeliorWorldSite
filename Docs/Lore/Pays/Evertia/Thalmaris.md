...
| **Gouvernement** | Monarchie bardique |
| **Culture** | Culture centrée sur les arts, la musique et la préservation des récits héroïques à travers les âges. |
| **Histoire marquante** | Le Chant des Anciens, une épopée chantée par les bardes de Thalmaris qui a uni le pays et ses voisins contre une menace commune. |
...
- **Azuralis** (R102) — *stub : description non renseignée dans le CSV*
- **Zylar** (R103) — *stub : description non renseignée dans le CSV*
- **Nalmir** (R104) — *stub : description non renseignée dans le CSV*
- **Ostaris** (R105) — *stub : description non renseignée dans le CSV*
- **Rylthos** (R106) — *stub : description non renseignée dans le CSV*
...
| Ville | Région | Type |
|-------|--------|------|
| Azuralith | Azuralis | Ville |
| Valornis | Azuralis | Village |
| Galrinor | Azuralis | Village |
| Zylarith | Zylar | Ville |
| Nalmiris | Nalmir | Ville |
| Myrdoris | Nalmir | Village |
| Elarinor | Nalmir | Village |
| Velrith | Nalmir | Village |
| Faloria | Nalmir | Village |
| Ostarith | Ostaris | Capitale |
| Galdaris | Ostaris | Village |
| Rylthoris | Rylthos | Ville |
| Thaloria | Rylthos | Village |
| Galdaroth | Rylthos | Village |
