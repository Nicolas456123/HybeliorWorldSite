...
| **N° Pays (CSV)** | 30 |
| **Nom CSV** | CendaraPays |
| **Continent (CSV)** | Cendara (N°16) |
| **Gouvernement** | Monarchie ésotérique |
| **Culture** | Culture centrée sur l'alchimie, la magie naturelle et les rituels mystiques. |
| **Histoire marquante** | Le Grand Rituel de Réveil, où les alchimistes de Cendara ont ramené à la vie une forêt entière après une catastrophe naturelle. |
| **Description CSV** | Un pays de forêts enchantées et de vallées mystiques, réputé pour ses alchimistes et ses rituels anciens. |

### Régions canoniques (source : Region.csv)

- **Brumancia** (R128) — *stub : description non renseignée dans le CSV*
- **Utophora** (R129) — *stub : description non renseignée dans le CSV*
- **Virendor** (R130) — *stub : description non renseignée dans le CSV*
- **Diamora** (R131) — *stub : description non renseignée dans le CSV*
- **Solara** (R132) — *stub : description non renseignée dans le CSV*
- **Malrith** (R133) — *stub : description non renseignée dans le CSV*
- **Meliflore** (R134) — *stub : description non renseignée dans le CSV*

### Villes canoniques (source : Ville.csv)

Total : **19 villes/villages** réparties sur **7 régions**.

| Ville | Région | Type |
|-------|--------|------|
| Brumaris | Brumancia | Capitale |
| Fyndoris | Brumancia | Village |
| Mylaris | Brumancia | Village |
| Uthorin | Utophora | Ville |
| Thaldor | Utophora | Village |
| Galron | Utophora | Village |
| Virondis | Virendor | Ville |
| Diamoris | Diamora | Ville |
| Kaldris | Diamora | Ville |
| Malthoris | Diamora | Village |
| Galrith | Diamora | Village |
| Solarith | Solara | Ville |
| Vyndria | Solara | Village |
| Thyroth | Solara | Village |
| Drystar | Malrith | Ville |
| Vylora | Malrith | Village |
| Thyronis | Malrith | Village |
