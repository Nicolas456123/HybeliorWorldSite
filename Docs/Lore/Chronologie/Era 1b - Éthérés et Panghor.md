---
tags: [lore, ère, éthérés, panghor, monts, refonte-2026-05]
type: lore
status: drafted
...
- Le Mont Originel = le **Mont Cendra** (observé)
- Le Mont Jumeau = mythiquement enfoui sous les glaces de Cestra ou au fond de l'océan (non observé, statut de *légende vive*)

#### Le Mont Originel — lecture cendarienne

**Pourquoi il se forme — selon la cosmologie cendarienne**
- La lecture la plus répandue : quand Eldoria tisse la matière depuis le Vide, elle cherche un *point d'ancrage*. La matière cosmique se concentrerait aux endroits où la résonance des Éternels est la plus forte. Le Mont Originel serait ce point de concentration maximale — le premier endroit où la matière décide de rester en place plutôt que de se disperser.
- Les chroniqueurs cendariens affirment qu'il n'est pas *le plus grand* pic du Panghor, mais qu'il serait *le plus dense en énergie cosmique*. Pour les médiums du Lien (Ères III et postérieures), la Trame du Lien y serait plus concentrée que nulle part ailleurs — c'est une *expérience subjective* rapportée, pas une mesure.
- Sa forme originelle, telle que la décrivent les récits : un pic parfaitement conique, d'une roche noire presque vitreuse — comme si le cosmos avait fondu et refroidi en un seul point. Cette roche existe sous les couches de lave actuelles : les mines de "Pierre Noire de Cendra" en extraient effectivement des fragments aux propriétés inhabituelles.

**Le récit de Flamara — tradition cendarienne**
- Selon les récits fondateurs de Cendara, Flamara aurait, en émergeant, cherché instinctivement le lieu de plus grande énergie — le Mont Originel.
- Le récit insiste sur une dimension symbolique : en s'installant au *premier* ancrage du monde physique, elle aurait affirmé que la transformation est au cœur de la création, pas en périphérie.
- Selon cette tradition, son installation n'aurait pas été douce : elle aurait *percé* le Mont Originel par le bas, transformé sa structure interne en chambre magmatique, fait jaillir le premier volcan du monde — événement fondateur dans la mythologie cendarienne.
- Les fidèles affirment que Flamara ne "vit" pas dans le cratère mais *est* le feu du mont — présence diffuse dans toute la chaleur interne. Quand le Mont Cendra pulse (~10 000-10 200 ap.A), beaucoup interprètent ces pulsations comme son agitation. Les Déliés et les érudits de Lumasar tiennent ces pulsations pour un phénomène géologique observé dont la cause reste débattue.

**La géologie du Mont Cendra — observations attestées**
La stratigraphie du Mont Cendra est documentée par les forages, les éruptions et les expéditions des Ères tardives. En descendant dans les couches rocheuses :

- *Couche superficielle (Ères IV-VII) :* Lave solidifiée des éruptions récentes. Pierre rouge-orangée, poreuse, chaude au toucher même sans soleil. Les forgerons de Cendara en font des outils réputés indestructibles.
- *Couche intermédiaire (Ères I-III) :* Lave ancienne, noire et lisse. Dense. Certaines veines incluent des cristaux phosphorescents (que les traditions cendariennes attribuent à un Éthéré local nommé *Luminarc*). Les alchimistes de l'Ère VI y trouvent des minéraux rares.
- *Couche profonde :* La **Pierre Noire vitreuse** — matériau effectivement extrait, antérieur à toute trace de volcanisme. Presque impossible à extraire intacte. Les fragments qui remontent lors des éruptions sont traités comme des objets sacrés par les traditions de Cendara, qui les disent *originels* ; les pétrologues sceptiques les analysent comme une obsidienne primordiale.
- *Le cœur (non observé) :* Selon les médiums du Lien les plus avancés, il y aurait au centre du Mont Cendra quelque chose qui n'est ni roche ni lave — un espace de "pure énergie cosmique" où le Substrat du Vide n'aurait jamais été complètement transformé en matière. Cette affirmation est **invérifiable** : aucun forage n'a atteint cette profondeur. Plusieurs Déliés de l'Ère VII cherchent à y accéder par voie méditative ; les Gardiens de Cendra (ordre religieux de l'Ère VII) s'y opposent avec acharnement. Le débat est théologique avant d'être physique.

**Symbolisme du Mont Cendra dans les différentes lectures**
- *Pour les théologies cendariennes* : c'est l'Ancre — le point depuis lequel tout le reste du monde peut être mesuré, premier chef-d'œuvre attribué à Eldoria, lieu où la lecture *Ignis Aeternum* situerait Flamara.
- *Pour les chroniques de Navigor (Pacte Mémorisé)* : il y serait tracé le premier chemin entre les plans — affirmation contestée par les autres traditions.
- *Pour les Éthérés cendariens* : *Embrasur* (selon la nomenclature locale, esprit des coulées et chambres magmatiques) s'installe dans la ceinture volcanique autour du Mont — gardien périphérique du foyer central.
- *Pour les peuples mortels (Ère III et après)* : c'est le lieu le plus chargé spirituellement du monde. Toutes les religions, même celles qui s'ignorent, ont un rapport au Mont Cendra — positif (lieu de révélation) ou négatif (lieu maudit, scène de l'Arrachement).
...
- Selon les chroniques cestariennes, **il aurait disparu lors de la Fracture du Panghor** : la séparation Nord/Sud l'aurait isolé, puis la Fracture 3 (dérive de Cestra) l'aurait recouvert de glaces. Il serait aujourd'hui soit sous les glaciers de Cestra, soit enfoui sous l'océan entre Cestra et le reste du monde.
- Sa localisation exacte est **inconnue**. Aucun texte vérifiable n'en donne les coordonnées. Retrouver le Mont Jumeau est un thème récurrent des prophéties cestariennes et un motif périodique de financement d'expéditions à l'Ère VII — ses prétendues réserves d'énergie cosmique pourraient, *si elles existaient*, contrebalancer le Mont Cendra en effervescence.

**Les deux Monts comme système — lecture cosmologique des traditions**
- Selon la lecture la plus partagée (Cendara + Cestra, recoupement d'*Ignis Aeternum* et des traditions cestariennes), les deux Monts formaient les deux pôles d'un axe énergétique traversant le Panghor. Cet axe aurait structuré le flux du Lien cosmique — une "colonne vertébrale" de la Trame.
- Leur séparation (Fracture 1) aurait affaibli cet axe. Plusieurs traditions y voient une explication à la difficulté croissante d'accéder au Lien à partir de l'Ère II.
- L'Étudiant choisit le Mont Cendra pour l'Arrachement (Ère IV) en s'appuyant sur cette lecture : couper la Trame au lieu de plus grande concentration du Lien, c'est couper l'axe énergétique à sa source — une rupture maximale. *Que cet axe ait jamais existé physiquement reste une question ouverte ; mais l'Étudiant y croyait, et ses ennemis aussi.*

**Ce que les mortels racontent du Mont Jumeau**
- *La Légende du Frère Froid (tradition orale de Cestra, attestée Ère V-VI) :* « Quand les deux Monts existaient encore ensemble, le monde était chaud et froid à la fois, et nul vent ne durait plus d'un jour. Quand le Frère Froid fut exilé sous les glaces, le monde perdit son équilibre. Un jour le Frère Froid se réveillera, et les deux Frères se parleront à travers le monde, et les Failles se fermeront. »
- *La Carte de Mernath (texte perdu, cité dans des archives de Galenor, Ère VI) :* Un cartographe nommé Mernath aurait tracé, au milieu de l'Ère III, une carte indiquant la localisation précise du Mont Jumeau sous les glaces de Cestra. Cette carte est **perdue depuis l'Arrachement** ; son existence même n'est connue que par des références secondaires. Des expéditions à l'Ère VI et VII ont cherché ces archives dans les ruines de l'académie où Mernath aurait travaillé, sans succès.
- *La théorie des Déliés (Ère VII) :* Plusieurs Déliés avancés affirment avoir "senti" le Mont Jumeau en méditation profonde — une présence froide, très ancienne, à une profondeur impossible sous la glace de Cestra. Ils ne peuvent pas le localiser. Ces témoignages sont **subjectifs** et restent sujets à caution : ils peuvent indiquer une réalité enfouie, ou une trace mémorielle collective transmise par la culture cestarienne. Les sceptiques notent que les Déliés ayant grandi loin de Cestra ne rapportent pas cette sensation.
...
- *Personnalité (telle que rapportée par les théologies cendariennes) :* Contrairement à *Flamara* (impulsive, dans la lecture cendarienne), Embrasur est décrit comme *méthodique*. Il forgerait les îles comme un artisan. Son rapport à Terranu (son autre parent) lui donnerait une patience que les récits ne prêtent pas à Flamara — il prendrait le temps de solidifier ce qu'il a créé avant de le transformer.
- *Impact sur les mortels :* Les habitants de Cendara construisent leurs villes sur des fondations de pierre volcanique qui refroidit depuis des siècles. Ils savent intuitivement quels volcans sont "d'Embrasur" (en repos mais vivants) et quels sont "de Flamara" (imprédictibles) — distinction observable dans les comportements éruptifs, transmise par les pratiques de construction et les rituels de fondation des villes plutôt que par une doctrine théologique unifiée.
