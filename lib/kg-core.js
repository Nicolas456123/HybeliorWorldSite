'use strict';
/*
 * lib/kg-core.js — Le cœur de la CONCORDANCE, le savoir canonique d'Hybélior.
 *
 * « La Concordance » est le nom du savoir que ce graphe porte. Elle sait tout
 ...
 * mystères ; la Concordance, elle, n'en garde aucun. Quand une bible, une
 * fiche ou un chapitre la contredit, c'est la Concordance qui a raison — et
 * si elle a tort, on la corrige ICI, pas ailleurs. Son nom fait écho, à
 * dessein, au Bureau des Concordances des romans : là-bas on classe les
 * silences, ici on accorde les sources.
 *
...
//   ⚠ Le SITE n'est jamais restreint : il sait tout et montre tout. C'est la
